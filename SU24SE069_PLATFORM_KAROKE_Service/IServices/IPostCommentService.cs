...
namespace SU24SE069_PLATFORM_KAROKE_Service.IServices
{
    public interface IPostCommentService
    {
        ...
        public Task<DynamicModelResponse.DynamicModelsResponse<PostCommentViewModel>> GetComments(PostCommentViewModel filter, PagingRequest paging, PostCommentFilter orderFilter);
