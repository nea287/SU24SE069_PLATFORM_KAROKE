...
namespace SU24SE069_PLATFORM_KAROKE_Service.IServices
{
    ...
    {
        public Task<ResponseResult<ReportViewModel>> GetReportById(string id);
        ...
        public Task<ResponseResult<ReportViewModel>> UpdateReportByMemberAccount(Guid reportId, CreateReportForMemberRequestModel request);
