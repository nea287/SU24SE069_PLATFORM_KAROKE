...
{
    public class DashboardGameRepository : BaseRepository<InAppTransaction>, IDashboardGameRepository
    {
        ...
        public async Task<Dictionary<int, decimal>> GetDashboardByMonth(int? month = null, int? startMonth = null, int? endMonth = null, int? startYear = null, int? endYear = null)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    var data1 = Enumerable.Range(startMonth.Value, (endMonth.Value - startMonth.Value));
