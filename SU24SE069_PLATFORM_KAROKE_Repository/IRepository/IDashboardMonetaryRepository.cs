...
namespace SU24SE069_PLATFORM_KAROKE_Repository.IRepository
{
    ...
    {
        public Task<Dictionary<int, decimal>> GetDashboardByMonth(int? month = null, int? startMonth = null, int? endMonth = null, int? startYear = null, int? endYear = null);
        ...
        public Task<Dictionary<DateTime, decimal>> GetDashboardByTransaction(DateTime? date = null, DateTime? startDate = null, DateTime? endDate = null);
